    ...
    return (
                               ...
                               className="js-sidebar-open active">
                                <svg className="olymp-menu-icon left-menu-icon" data-toggle="tooltip"
                                    ...
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-menu-icon"></use>
                                </svg>
                            </a>
                        </li>
                        <li>
                            <a href="https://html.crumina.net/html-olympus/03-Newsfeed.html">
                                <svg className="olymp-newsfeed-icon left-menu-icon" data-toggle="tooltip"
                                    ...
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-newsfeed-icon"></use>
                                </svg>
                            </a>
                        </li>
                        <li>
                            <a href="https://html.crumina.net/html-olympus/16-FavPagesFeed.html">
                                <svg className="olymp-star-icon left-menu-icon" data-toggle="tooltip"
                                    ...
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-star-icon"></use>
                                </svg>
                            </a>
                        </li>
                    </ul>
                    <div className="ps__scrollbar-x-rail" style={{"width": "70px", "left": "0px", "bottom": "0px"}}>
                        <div className="ps__scrollbar-x" tabIndex="0" style={{"left": "0px", "width": "64px"}}></div>
                    </div>
        ...
        <div className="fixed-sidebar fixed-sidebar-responsive">
            ...
            <div className="fixed-sidebar-left sidebar--small" id="sidebar-left-responsive">
                <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#" className="logo js-sidebar-open">
                               ...
                               className="author-name fn">
                                <div className="author-title">
                                    ...
                                    <svg className="olymp-dropdown-arrow-icon">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                             xlink:href="assets/img/./icons.svg#olymp-dropdown-arrow-icon"></use>
                                    </svg>
                                </div>
                    ...
                    <ul className="left-menu">
                            ...
                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#"
                               className="js-sidebar-open">
                                <svg className="olymp-close-icon left-menu-icon">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-close-icon"></use>
                                </svg>
                        ...
                        <li>
                            <a href="https://html.crumina.net/html-olympus/Mobile-28-YourAccount-PersonalInformation.html">
                                <svg className="olymp-star-icon left-menu-icon" data-toggle="tooltip"
                                     data-placement="right" data-original-title="FAV PAGE">
                                    <use xmlns:xlui-blockink="http://www.w3.org/1999/xlink"
                        ...
                        <li>
                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#">
                                <svg className="olymp-logout-icon">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-logout-icon"></use>
                                </svg>
                ...
                <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#"
                   className="olympus-chat inline-items js-chat-open">
                    <svg className="olymp-chat---messages-icon">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                             xlink:href="assets/img/./icons.svg#olymp-chat---messages-icon"></use>
                    </svg>
                </a>
            ...
            <div className="fixed-sidebar-right sidebar--large" id="sidebar-right-1">
                ...
                <div className="mCustomScrollbar ps ps--theme_default ps--active-y" data-mcs-theme="dark"
                        ...
                        <li className="inline-items js-chat-open">
                            ...
                            <div className="more">
                                <svg className="olymp-three-dots-icon">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-three-dots-icon"></use>
                                </svg>
                                ...
                                <ul className="more-icons">
                                    <li>
                                        <svg data-toggle="tooltip" data-placement="top"
                                            ...
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                 xlink:href="assets/img/./icons.svg#olymp-comments-post-icon"></use>
                                        </svg>
                                    </li>
                                    ...
                                    <li>
                                        <svg data-toggle="tooltip" data-placement="top"
                                            ...
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                 xlink:href="assets/img/./icons.svg#olymp-add-to-conversation-icon"></use>
                                        </svg>
                                    </li>
                                    ...
                                    <li>
                                        <svg data-toggle="tooltip" data-placement="top"
                                            ...
                                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                 xlink:href="assets/img/./icons.svg#olymp-block-from-chat-icon"></use>
                                        </svg>
                                    </li>
                                </ul>
                    ...
                    <div className="ps__scrollbar-y-rail" style={{"top": "0px", "height": "766px", "right": "0px"}}>
                        <div className="ps__scrollbar-y" tabIndex="0" style={{"top": "0px", "height": "709px"}}></div>
                    </div>
                </div>
                    ...
                    <a href="https://html.crumina.net/html-olympus/29-YourAccount-AccountSettings.html"
                       className="settings">
                        <svg className="olymp-settings-icon">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                 xlink:href="assets/img/./icons.svg#olymp-settings-icon"></use>
                        </svg>
                    </a>
            ...
            <div className="header-content-wrapper">
                    ...
                    <div className="form-group with-button is-empty">
                        <button style={{"backgroundColor": "transparent"}}>
                            <svg className="olymp-magnifying-glass-icon">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                     xlink:href="assets/img/./icons.svg#olymp-magnifying-glass-icon"></use>
                            </svg>
                        </button>
                ...
                <div className="control-block">
                    ...
                    <div className="author-page author vcard inline-items more">
                        ...
                        <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html" className="author-name fn">
                            <div className="author-title">
                                {user.username} {user.verified}
                                <svg className="olymp-dropdown-arrow-icon">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                           ...
                           href="https://html.crumina.net/html-olympus/02-ProfilePage.html#request" role="tab">
                            <div className="control-icon has-items">
                                <svg className="olymp-happy-face-icon">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-happy-face-icon"></use>
                                </svg>
                           ...
                           href="https://html.crumina.net/html-olympus/02-ProfilePage.html#notification" role="tab">
                            <div className="control-icon has-items">
                                <svg className="olymp-thunder-icon">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                         xlink:href="assets/img/./icons.svg#olymp-thunder-icon"></use>
                                </svg>
                                           ...
                                           className="accept-request">
											<span className="icon-add without-text">
												<svg className="olymp-happy-face-icon"><use
                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    xlink:href="assets/img/./icons.svg#olymp-happy-face-icon"></use></svg>
											</span>
										</a>
                            ...
                            <li className="accepted">
                                ...
                                <div className="more">
                                    ...
                                    <svg className="olymp-little-delete">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                             xlink:href="assets/img/./icons.svg#olymp-little-delete"></use>
                                    </svg>
                                </div>
                            </li>
                            <li>
                ...
                <div className="tab-pane " id="chat" role="tabpanel">
                    ...
                    <div className="mCustomScrollbar ps ps--theme_default" data-mcs-theme="dark"
                        ...
                        <div className="ui-block-title ui-block-title-small">
                            ...
                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#">Mark all as read</a>
                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#">Settings</a>
                        </div>
                                    ...
                                    <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div className="form-group label-floating">
                                            ...
                                            <textarea className="form-control"
                                                      placeholder="i just love sucking that fine huge werewolf cock and swallowing all the cum while he thrusts his massive hips against my mouth making me his slut and breeding me until he howls and cums in my insides huff so warm so full daddy made me his bitch"></textarea>
                                            <span className="material-input"></span></div>
                                        ...
                                        <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <button className="btn btn-primary btn-lg full-width">Save all Changes
                                            </button>
                                        </div>
