                                ...
                                <article className="hentry post has-post-thumbnail shared-photo">
                                    ...
                                    <div className="post__author author vcard inline-items">
                                        ...
                                        <div className="author-date">
                                            <a className="h6 post__author-name fn"
                                               href="https://html.crumina.net/html-olympus/02-ProfilePage.html">{user.username} {user.verified}</a> shared
                                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#">{user.username} {user.verified}</a>’s <a
                                            href="https://html.crumina.net/html-olympus/02-ProfilePage.html#">photo</a>
                                            <div className="post__date">
                                                <time className="published" dateTime="2017-03-24T18:18">
                                                    7 hours ago
                                                </time>
                            ...
                            <div className="ui-block"
                                ...
                                <article className="hentry post video">
                                    ...
                                    <div className="post__author author vcard inline-items">
                                        ...
                                        <div className="author-date">
                                            <a className="h6 post__author-name fn"
                                               href="https://html.crumina.net/html-olympus/02-ProfilePage.html">{user.username} {user.verified}</a> shared
                                            a
                                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#">link</a>
                                            <div className="post__date">
                                                <time className="published" dateTime="2017-03-24T18:18">
                                                    7 hours ago
                                                </time>
                                    ...
                                    <div className="post-video">
                                        ...
                                        <div className="video-content">
                                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#"
                                               className="h4 title">System of a Revenge - Nothing Else Matters
                                                (LIVE)</a>
                                            <p>Lorem ipsum dolor sit amet, consectetur ipisicing elit, sed do eiusmod
                                                tempo incididunt ut labore..</p>
                                            <a href="https://html.crumina.net/html-olympus/02-ProfilePage.html#"
